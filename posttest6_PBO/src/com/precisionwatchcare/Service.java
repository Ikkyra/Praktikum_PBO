...
public class Service {
    ...
    // Overloaded constructor - without cost parameter (default to 0)
    public Service(String serviceId, String serviceType, boolean useCourier) {
        this(serviceId, serviceType, 0, useCourier);
    }

    // Overloaded constructor - without courier parameter (default to false)
    public Service(String serviceId, String serviceType) {
        this(serviceId, serviceType, 0, false);
    }
    ...
    public String toString() {
        return "Service [ID: " + serviceId + ", Type: " + serviceType + 
               ", Cost: Rp" + cost + ", Status: " + status + 
               ", Use Courier: " + useCourier + "]";
    }
}